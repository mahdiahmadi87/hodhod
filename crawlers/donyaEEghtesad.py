...
def crawler():
    feed = feedparser.parse("https://donya-e-eqtesad.com/feeds/")
    ...
    for entry in feed.entries:  
        try:        
            ...
            try:
                ...
                print("ID Not found! generated to 30100001")
                id = "30100001"
                ids = [30100001]
            ...
            cursor.execute(f"INSERT INTO News VALUES ('{id}', '{siteId}', 'donyaEEghtesad', '{entry.title}', '{abstract}', '{topic}',  '{entry.link}', '{pub}', '{image}')")
            conn.commit() 
            print("Added")
        except:
            i -= 1
...
if __name__ == "__main__":
    while True:
        print(u"\033[34mDonyaEEghtesad Crawler Is Running!\033[0m")
        try:
